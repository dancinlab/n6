...
Generates `docs/preview.html` — side-by-side rendering of every `examples/*.n6` with `github-dark` + `github-light` themes via [shiki](https://shiki.style/).
...
- After editing `syntaxes/n6.tmLanguage.json`
