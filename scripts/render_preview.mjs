...
const repo = '/Users/ghost/core/n6';
const grammar = JSON.parse(readFileSync(join(repo, 'syntaxes/n6.tmLanguage.json'), 'utf8'));
...
const renders = examples.map(f => {
  ...
  return {
    name: f,
    dark: hl.codeToHtml(src, { lang: 'n6', theme: 'github-dark' }),
    light: hl.codeToHtml(src, { lang: 'n6', theme: 'github-light' })
  };
});
...
<html lang="en"><head>
<meta charset="utf-8">
<title>⬢ n6 — syntax highlighting preview</title>
<style>
...
<h1>⬢ n6 — syntax preview</h1>
<p class="meta">Rendered with <a href="https://shiki.style/">shiki</a> using the grammar at <code>syntaxes/n6.tmLanguage.json</code>. Left = <code>github-dark</code>, right = <code>github-light</code>.</p>
${renders.map(r => `
